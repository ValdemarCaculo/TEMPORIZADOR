...
const elementosA = () => {
    ...
    if (accao == 'start' || accao == 'continue') {
        ...
        button.innerText = '<i class="fa-solid fa-pause"></i>'
    } else if (accao == 'pause') {
        button.setAttribute('accao', 'continue');
        button.innerText = '<i class="fa-solid fa-play"></i>'
...
document.getElementById('inicio').addEventListener('click', elementos)